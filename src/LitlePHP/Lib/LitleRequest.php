...
class LitleRequest
{
    ...
    {
        return ($this->total_transactions + $addl_txns_count) > LitleConstants::$MAX_TXNS_PER_REQUEST;
    }
     ...
     * request file
     */
    public function addBatchRequest(BatchRequest $batch_request)
    {
     ...
     */
    public function retrieveFromLitleSFTP(SFTP $session, $sftp_timeout=7200)
    {
        $time_spent = 0;
     ...
     */
    public function downloadFromLitleSFTP(SFTP $session, $time_spent, $sftp_timeout)
    {
